...
Use this reference for current Fable prompting. `references/40-fable-5.md` preserves the
...
workload-specific advantage. An explicit comparison may test Fable for unresolved demanding
reasoning or long-horizon work after diagnosing the current profile's context and tools.
