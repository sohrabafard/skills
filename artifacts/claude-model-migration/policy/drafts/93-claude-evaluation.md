...
The separate `assets/evals/claude-agent-comparisons.json` corpus carries eight concrete tasks,
fixtures, acceptance criteria and forbidden actions. Each compares two configurations twice
in fresh contexts. Every case stays unrun; results belong in separate evidence records.
