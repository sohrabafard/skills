...
The `schema_config` block defines how Loki stores and indexes data. **This is critical and cannot be changed after
...
> **Breaking Change (Loki 3.3+):** Bloom filters use structured metadata only (not free-text). Delete existing bloom
