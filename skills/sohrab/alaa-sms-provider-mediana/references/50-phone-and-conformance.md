...
1. Fold Persian-Indic digits (U+06F0 to U+06F9) and Arabic-Indic digits (U+0660 to U+0669) to ASCII. Fold nothing else: a normaliser that accepts every Unicode digit family accepts superscripts and Devanagari, which no Iranian subscriber types and no vendor renders.
