...
- If the environment is WSL, containerized Linux, or a remote Linux shell, switch examples accordingly.
...
```powershell
Add-Content -Path .\docs\_agent_plans\20260405-143015_task.md -Value "- 2026-04-05T14:35:10Z - Validation passed"
```

## Artifact bootstrap examples

### Create a parent plan and state
...
- If a validation command is slow or noisy, run it at phase boundaries and record the summary in the plan instead of pasting raw output.
