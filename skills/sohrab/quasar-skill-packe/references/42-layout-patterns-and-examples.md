...
- Pair this file with `10-cli-vite-and-config.md` when the layout issue touches routing/bootstrap structure.
- Pair this file with `20-ssr-pwa-and-security.md` when layout state depends on SSR or hydration.
