...
| A plugin, composable, directive, option, or util such as `Notify`, `Loading`, `useMeta`, `useHydration`, `v-ripple`, or `Screen` | `50-plugins-composables-directives-options-utils.md` and `51-directive-usage-atlas.md` for directives | `20-ssr-pwa-and-security.md` for SSR-sensitive APIs                                               |
