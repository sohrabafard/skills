...
- `quasar-cli-vite-*` (77 skills)
  - covered by `10-cli-vite-and-config.md`, `30-platform-modes.md`, and `70-upstream-deltas-and-live-checks.md`
- `quasar-component-*` (75 skills)
  - covered by `40-components-and-layouts.md` plus `60-guardrails-a11y-performance-monorepo.md`
...
- If the old name starts with `quasar-cli-vite-`, search the feature phrase inside `10` or `30`.
- If the old name starts with `quasar-component-`, search the exact symbol inside `40`.
- If the old name starts with `quasar-composable-`, `quasar-directive-`, `quasar-plugin-`, `quasar-options-`, or `quasar-utils-`, search the exact API name inside `50`.
