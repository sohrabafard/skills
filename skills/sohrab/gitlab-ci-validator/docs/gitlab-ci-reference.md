...
GitLab CI/CD pipelines are defined in `.gitlab-ci.yml` files using YAML syntax. The file must be located at the root of
your repository. The order of keywords is not important unless otherwise specified.
