...
| Cross-repository ownership, contracts, and handoffs | Catalog, contract registry, hosting surface, or approved memory surface | Local static evidence cannot prove another repository. |
