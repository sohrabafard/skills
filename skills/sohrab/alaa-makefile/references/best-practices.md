...
For modern, robust Makefiles, start with this recommended preamble
from [Jacob Davis-Hansson](https://tech.davis-hansson.com/p/make/):
...
**Always include `.DELETE_ON_ERROR:`** at the top of your Makefile. This ensures partially built targets are deleted
when a recipe fails, preventing corrupt builds.
...
**From GNU Make Manual:** *"This is almost always what you want make to do, but it is not historical practice; so for
