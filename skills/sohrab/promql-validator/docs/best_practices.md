...
**What they are**: Multiple time series representing bucketed observations. Metrics end with `_bucket`, `_sum`,
`_count`.
...
Native histograms are a newer histogram format introduced in Prometheus 2.40 and made stable in 3.0. They offer
significant storage and query efficiency improvements over classic histograms.
