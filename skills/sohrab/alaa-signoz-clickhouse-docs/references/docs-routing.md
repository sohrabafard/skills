...
| Trace missing spans warning                      | `https://signoz.io/docs/userguide/traces/#missing-spans`                                               | SigNoz shows "This trace has missing spans" or a trace has parent span IDs with no collected parent | Use with instrumentation guardrails and ClickHouse anti-join verification |
