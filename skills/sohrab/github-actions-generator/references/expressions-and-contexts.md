...
**Security Warning:** Never directly interpolate untrusted input (PR titles, issue bodies, user input) in `run`
commands. Always use environment variables via the `env` context.
