...
Act is a tool that allows you to run your GitHub Actions locally, providing fast feedback and acting as a local task
runner.
...
This is especially important on ARM-based Macs (M1/M2/M3) to ensure workflows run in the same environment as GitHub's
x64 runners.
...
**Solution**: Some actions may not be available locally. Use `-P` to specify alternative Docker images or skip the
problematic action for validation purposes
