...
2. Read `references/source-map.md` when the task mentions latest/current/version/security/current behavior, plugin parameters, or Kubernetes/OpenTelemetry/Loki output behavior.
