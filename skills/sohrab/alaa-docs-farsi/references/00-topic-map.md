...
Use this file to jump directly to the most relevant topic reference first.
Use `full-guide.md` when you need the entire contract in one place or when several topics overlap heavily.

## Covered sections

- `references/10-language-and-links.md`
- `# Purpose`
- `# When to use`
- `# When NOT to use`
...
- `references/20-readme-big-picture-contract.md`
...
- `references/30-api-summary-contract.md`
...
- `references/50-data-architecture-contract.md`
...
- `references/60-errors-events-observability-contract.md`
...
- `references/70-subagent-doc-workflows.md`
...
- `references/40-sync-workflow-and-evidence.md`
...
- Fall back to `full-guide.md` when the task spans multiple topics or when a split file looks incomplete.
