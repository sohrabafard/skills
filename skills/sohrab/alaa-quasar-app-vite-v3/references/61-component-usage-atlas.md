...
- If the task is really about deterministic image delivery, shared placeholders, or SSR-safe responsive candidate generation, also open `63-image-delivery-and-placeholders.md`.
- Good search terms:
...
- For deeper layout semantics such as `view`, containerized layouts, overlay/fixed behavior, and nested route structure, also open `62-layout-patterns-and-examples.md`.
