...
- Pair this file with `31-ssr-pwa-and-security.md` whenever the API can affect SSR, hydration, meta timing, or browser-only behavior.
- Pair this file with `21-cli-vite-and-config.md` when the API question is actually a global option or config question.
