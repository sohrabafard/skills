...
- Pair this file with `31-ssr-pwa-and-security.md` if the directive affects hydration timing, client-only APIs, or visibility-based data loading in SSR routes.
