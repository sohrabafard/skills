...
- Pair this file with `61-component-usage-atlas.md` for baseline `QImg` behavior.
- Pair this file with `31-ssr-pwa-and-security.md` when lazy loading, offline behavior, or hydration safety is involved.
