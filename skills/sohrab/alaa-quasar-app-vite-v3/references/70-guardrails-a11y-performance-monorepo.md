...
- `22-cli-cookbook-and-examples.md` for Quasar config, boot, routing, and bundler wiring
- `61-component-usage-atlas.md` for component/layout usage and alternatives
- `65-directive-usage-atlas.md` for directive behavior and snippet shape
...
If you need the exact bundler/config snippet for dedupe or alias wiring, also load `22-cli-cookbook-and-examples.md`.
