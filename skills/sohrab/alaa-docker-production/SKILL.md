...
description: "Production Docker/Compose hardening for Laravel/PHP (Octane/Swoole): multi-stage builds, deterministic pinning (prefer digests for releases), non-root runtime, minimal images, healthchecks, secrets handling, OS tuning, safe exposure patterns, and optional release evidence artifacts (SBOM/scan) per policy."
---
